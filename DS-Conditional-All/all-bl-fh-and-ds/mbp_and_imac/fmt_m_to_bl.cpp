...
// --------------------   --------------------    --------------------
// May 2018               Lalintha Polpitiya      Fast Mobius Tranformation (FMT) Mass to Belief
//
//**************************************************************************************************
...
int main()
{
	...
	for (int i = 0; i < fod; i++)
	{
	   for (int j = 0; j < pow(2, fod - i); j += 2)	
		   for (int k = 0; k < pow(2, i); k++)
			   a[(j + 1) * (int)pow(2, i) + k] += a[j * (int)pow(2, i) + k];
